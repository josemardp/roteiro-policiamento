...
import { calcularHoraTermino } from "@/lib/gerarCPP";
    ...
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      <div className="container py-6 max-w-2xl">
        <div className="space-y-6">
          ...
          {/* Blocos Manuais (se selecionado) */}
          {modalidadeGeracao === "manual" && (
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Insira as atividades (ex: 19h00 as 21h00 bloqueio de transito)
              </label>
              <textarea
                value={blocosManuais}
                onChange={(e) => setBlocosManuais(e.target.value)}
                placeholder="17h00 a 17h30 prelecao assuncao&#10;19h00 as 21h00 bloqueio de transito&#10;21h00 janta pel pm"
                className="w-full px-4 py-3 rounded-lg border border-gray-300 text-base font-medium focus:outline-none focus:ring-2 focus:ring-[#0a2540] h-24 resize-none"
              />
              <p className="text-xs text-gray-600 mt-1">
                Aceita formatos: 19h00, 19:00, 19h00 a 21h00, 19h00 as 21h00, etc.
              </p>
            </div>
          )}

          {/* Efetivo / Viatura / Prefixo (opcional) */}
          ...
          <button
            ...
            className="w-full btn-tactical text-lg font-bold py-4 mt-8"
          >
            Gerar CPP do Turno
          </button>
        </div>

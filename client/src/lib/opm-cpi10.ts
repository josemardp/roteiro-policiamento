...
export const OPM_CPI10: OPMData[] = [
  ...
  { municipio: "Castilho",                   unidade: "Sede Pel / 1ª Cia / 28º BPM/I",   endereco: "Praça Cel. Seraphim Pereira, s/n — Centro, Castilho/SP",                    lat: -20.8717, lng: -51.4894, tipoEndereco: "CENTRO_MPAL", tempoAMin: 73,  tempoBMin: 95  },
  ...
  { municipio: "Lavínia",                    unidade: "Gp PM / 3ª Cia / 28º BPM/I",      endereco: "Praça dos Expedicionários, s/n — Centro, Lavínia/SP",                       lat: -21.1600, lng: -51.0561, tipoEndereco: "CENTRO_MPAL", tempoAMin: 20,  tempoBMin: 43  },
